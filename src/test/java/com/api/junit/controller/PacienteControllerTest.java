...
import com.api.junit.exception.InvalidRequestException;
import com.api.junit.exception.NotFoundException;
...
public class PacienteControllerTest{
    ...
    @Autowired
    private MockMvc mockMvc;//nos ayuda a simular

    @Autowired
    private ObjectMapper objectMapper; //convertimos objetos de un tipo (jsoan) a otro tipo (java) y visceversa
    ...
    @Test
    @DisplayName("Eliminar no encontado")
